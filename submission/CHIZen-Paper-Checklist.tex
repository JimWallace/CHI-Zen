...
%\titlespacing{\subsection}{8pt}{\parskip}{-\parskip}
...
\pagestyle{fancy}
\rhead{\href{http://hci.uwaterloo.ca}{\includegraphics[width=5cm]{submission/figures/uwhci-full-cs.png}}}
...
% Other Resources, not yet included:
%
