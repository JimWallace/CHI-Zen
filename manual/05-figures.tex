Treatment    Z0_posaffect    Z0_negaffect    Z0_attentive    Z1_posaffect    Z1_negaffect    Z1_attentive    Z2_posaffect    Z2_negaffect    Z2_attentive
1	4.00	1.00	3.00	3.25	1.44	2.00	4.75	1.00	2.50
1	2.75	1.22	2.50	1.00	4.22	1.50	2.25	1.33	3.00
1	2.75	1.11	2.50	1.00	1.72	2.00	1.00	1.78	1.00
1	2.25	1.56	3.50	1.50	2.33	3.00	3.25	1.00	3.50
1	2.00	1.11	3.50	1.25	3.00	3.00	2.50	1.11	3.00
1	3.75	1.33	4.00	1.25	2.78	3.50	3.25	1.22	3.00
1	3.25	1.00	3.50	2.25	1.44	3.50	2.75	1.11	1.00
1	3.50	1.11	3.50	1.25	1.67	4.00	3.75	1.22	2.50
1	3.25	1.44	4.00	3.00	2.33	3.50	3.75	1.33	3.50
1	2.25	1.00	2.50	1.50	3.22	2.00	3.75	1.00	1.50
}\SZU
...
\begin{axis}[
    ...
    ytick={-2,-1,0,1,2},
    xtick={1,2,3},
    xticklabels={Baseline,Stressor,Game},
]
...
\end{axis}
\end{tikzpicture}
%\caption{Box plot of heart rate data collected during the study. Participants in Nature (left) vs Urban (right) conditions.}
%\end{figure}
...
\begin{axis}[
    ...
    width = \textwidth,
    ymin=-2.75, ymax=2.75,
    ylabel = Galvanic Skin Response ($z$-score), 
    ytick={-2,-1,0,1,2},
    xtick={1,2,3},
    xticklabels={Baseline,Stressor,Game},
    legend style={at={(0.25,-.2)},anchor=south,font={\sffamily}}
]
...
table[y=P1_GSR] {\SPN};
%\addlegendimage{fill=Nature,draw=Nature}
%\addlegendentry{Nature}
...
table[y=P2_GSR] {\SPU};
%\fill[Urban] (0,0) circle (0.1cm);
%\addlegendimage{fill=Urban,draw=Urban}
%\addlegendentry{Urban}
    
    \coordinate (legend) at (axis description cs:.15,-.15);
\end{axis}
...
\matrix [
    ...
    every node/.style={anchor=center}, 
        ...
        |[fill=Nature]| & |[font=\small\sffamily]|Nature & |[fill=white]| & |[fill=Urban]| & |[font=\small\sffamily]|Urban \\
    };
\end{tikzpicture}
\caption{A summary of Heart Rate and Galvanic Skin Response data collected during the study. Our analysis revealed a significant increase between Baseline and Stressor data, and a significant decrease between Stressor and Game data for both measures.}
\label{fig:physio}
...
table[y=Z2_attentive] {\SZN};
   
\end{axis}
\end{tikzpicture}
\caption{A summary of Positive Affect, Negative Affect, and Attentiveness self-reported ratings collected during the study. All measures were aggregated across 5-point Likert scale questions from the ZIPERS questionnaire.}
\label{fig:selfreports}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Gigantic Figure Ends here for physiological data... 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
